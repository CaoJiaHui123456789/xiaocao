...
public interface BaseDao {
	 ...
	 * 分页查询,返回jpa支持的page
	 */
	public <T> Page<T> findByJpaPage(final String hql, Object[] params, final int pageNo, final int maxResults) throws Exception;
	public <T> Page<T> findByJpaPage(final String hql, Object param, final int pageNo, final int maxResults) throws Exception;
	public <T> Page<T> findByJpaPage(final String hql, final int pageNo, final int maxResults) throws Exception;
	public  Page<Map<String,Object>> findByJpaMapPage(final String hql, Object[] params, final int pageNo, final int maxResults) throws Exception;
	public  Page<Map<String,Object>> findByJpaMapPage(final String hql, Object param, final int pageNo, final int maxResults) throws Exception;
	public  Page<Map<String,Object>> findByJpaMapPage(final String hql, final int pageNo, final int maxResults) throws Exception;
