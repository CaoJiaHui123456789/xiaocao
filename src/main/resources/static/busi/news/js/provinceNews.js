          ...
          $.ajax({
            ...
            ,success: function (result) {
              ...
              for (var i = 0; i < tablelist.length ; i++) {
                htmls = htmls + "<li><a href=\"provinceNews.html\">" + tablelist[i].newsHead + "</a></li>"
        ...
        $.ajax({
          ...
          success:function (result) {
            ...
            for(var i=0;i<newslist.length;i++){
              htmls=htmls+"<li class=\"wow flipInX\" data-wow-delay=\"0.6s\"> <a href=\"news/index35.html\"><img class=\"case_list_img\" src=\"../../../newsCont/picture/"+result.rows[i].picture+"\" width=\"246\" height=\"154\"></a>\n" +
                      "              <div class=\"txt\">\n" +
                      "                <div class=\"txt1\"> <a class=\"sl\" href=\"news/index35.html\">"+result.rows[i].newsName+"</a>\n" +
